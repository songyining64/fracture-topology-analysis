...
def get_edge_colors(G, attribute, return_palette=False, edge_color=None):
...
def plot_attribute(G, attribute, colorbar=True, **kwargs):
    ...
    if colorbar:
        ...
        cbar.ax.set_ylabel(attribute, rotation=270, fontsize=20)
...
def plot_compare_graphs(G, H, kwargs=None):
...
def plot_rose(G, ax=[]):
    ...
    #    'black')
    ax.set_title('角度玫瑰图', y=1.10, fontsize=20)
